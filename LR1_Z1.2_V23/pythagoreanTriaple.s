	.file	"pythagoreanTriaple.c"
	.intel_syntax noprefix
	.text
Ltext0:
	.globl	_GetPythagoreanTriaples
	.def	_GetPythagoreanTriaples;	.scl	2;	.type	32;	.endef
_GetPythagoreanTriaples:
LFB14:
	.file 1 "pythagoreanTriaple.c"
	.loc 1 5 0
	.cfi_startproc
	push	ebp
...
LBE3:
	...
	sub	WORD PTR [ebp-16], 1
L3:
	.loc 1 15 0 is_stmt 0 discriminator 1
	movzx	eax, WORD PTR [ebp-16]
	cmp	ax, WORD PTR [ebp-14]
	ja	L12
...
LFE14:
	.section .rdata,"dr"
LC0:
	.ascii "%hu^2 + %hu^2 = %hu^2\12\0"
	.text
	.globl	_PrintTriaples
...
Ldebug_info0:
	...
	.long	0x29f
	.uleb128 0xf
	.ascii "GetPythagoreanTriaples\0"
	.byte	0x1
	.byte	0x4
	.long	0x424
	.long	LFB14
	...
	.sleb128 -52
	.uleb128 0xe
	.ascii "minimum_possible_hypotenuse\0"
	.byte	0x1
	.byte	0x6
	.long	0xb9
	.uleb128 0x2
...
Ldebug_macro0:
	...
	.file 5 "c:/mingw/include/malloc.h"
	.byte	0x3
	.uleb128 0x4
	.uleb128 0x5
	.byte	0x1
	...
	.uleb128 0x36
	.ascii "__need_NULL \0"
	.file 10 "c:/mingw/lib/gcc/mingw32/6.3.0/include/stddef.h"
	.byte	0x3
	.uleb128 0x37
	.uleb128 0xa
	.byte	0x1
	...
	.file 12 "c:/mingw/lib/gcc/mingw32/6.3.0/include/stdarg.h"
	.byte	0x3
	.uleb128 0x66
	.uleb128 0xc
	.byte	0x2
