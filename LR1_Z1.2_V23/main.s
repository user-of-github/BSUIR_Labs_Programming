...
LC0:
	...
	.align 4
LC1:
	.ascii "response[0].result * response[0].result == response[0].first * response[0].first + response[0].second * response[0].second\0"
	.align 4
LC2:
	.ascii "response[1].result * response[1].result == response[1].first * response[1].first + response[1].second * response[1].second\0"
	.align 4
LC3:
	.ascii "response[3].result * response[3].result == response[3].first * response[3].first + response[3].second * response[3].second\0"
	.align 4
LC4:
	.ascii "response[5].result * response[5].result == response[5].first * response[5].first + response[5].second * response[5].second\0"
	.align 4
LC5:
	.ascii "response[7].result * response[7].result == response[7].first * response[7].first + response[7].second * response[7].second\0"
	.text
	.globl	_Test
...
Ldebug_macro0:
	...
	.file 6 "c:/mingw/include/malloc.h"
	.byte	0x3
	.uleb128 0x4
	.uleb128 0x6
	.byte	0x1
	.uleb128 0xf
	.ascii "_MALLOC_H_ \0"
	.file 7 "c:/mingw/include/_mingw.h"
	.byte	0x3
	.uleb128 0x12
	.uleb128 0x7
	.byte	0x1
	...
	.file 8 "c:/mingw/include/msvcrtver.h"
	.byte	0x3
	.uleb128 0x42
	.uleb128 0x8
	.byte	0x1
	...
	.byte	0x4
	.file 9 "c:/mingw/include/w32api.h"
	.byte	0x3
	.uleb128 0x49
	.uleb128 0x9
	.byte	0x1
	...
	.file 10 "c:/mingw/include/sdkddkver.h"
	.byte	0x3
	.uleb128 0x3b
	.uleb128 0xa
	.byte	0x1
	...
	.uleb128 0x36
	.ascii "__need_NULL \0"
	.file 11 "c:/mingw/lib/gcc/mingw32/6.3.0/include/stddef.h"
	.byte	0x3
	.uleb128 0x37
	.uleb128 0xb
	.byte	0x1
	...
	.file 13 "c:/mingw/lib/gcc/mingw32/6.3.0/include/stdarg.h"
	.byte	0x3
	.uleb128 0x66
	.uleb128 0xd
	.byte	0x2
	...
	.byte	0x4
	.byte	0x4
	.file 14 "c:/mingw/include/assert.h"
	.byte	0x3
	.uleb128 0x2
	.uleb128 0xe
	.byte	0x2
...
LASF0:
	...
	.def	_GetPythagoreanTriaples;	.scl	2;	.type	32;	.endef
	.def	_PrintTriaples;	.scl	2;	.type	32;	.endef
